...
object A_NeoType:
  ...
  private[libraries] type NieNumber = NieNumber.Type
  
  private[libraries] object NieNumber extends Newtype[String]:
  ...
  private[libraries] type DniNumber = DniNumber.Type
  
  private[libraries] object DniNumber extends Newtype[String]:
