...
import implementations.libraries.B_FullNeoType.*
import implementations.libraries.B_FullNeoType.DNI.*
import implementations.libraries.B_FullNeoType.NIE.*
import implementations.libraries.B_FullNeoType.ID.*
import utest.{assert, *}
